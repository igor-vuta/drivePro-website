    ...
    <main className="bg-jet-black min-h-screen">
      ...
      <section className="bg-charcoal py-12">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <span className="text-gold font-bold text-lg tracking-widest uppercase border-2 border-gold/40 px-8 py-4 bg-jet-black/80">
              {t('map_placeholder')}
            </span>
          </div>
          <p className="text-center text-cream/40 text-sm tracking-wider mt-6 uppercase">{t('service_area')}</p>
        </div>
      </section>
